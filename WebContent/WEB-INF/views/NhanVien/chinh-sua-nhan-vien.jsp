		...
		<div class="row">
			...
			<div class="col-lg-7" style="padding-bottom: 120px">
				<form action="${pageContext.request.contextPath}/chinh-sua-nhan-vien"
					method="POST" id="form_chinhsuanhanvien">
					<input type="hidden" name="id" id="id" value="<%=nhanVien.getId()%>">
					<div class="form-group">
						<label>Mã nhân viên: </label> <input class="form-control"
							type="text" name="manhanvien" id="manhanvien" value="<%=nhanVien.getMaNhanVien()%>" readonly="readonly" />
					</div>
					<div class="form-group">
						<label>Họ và tên: </label> <input class="form-control" type="text"
							name="hovaten" id="hovaten" value="<%=nhanVien.getHoTen()%>" required/>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	$(function() {
		$('#form_chinhsuanhanvien').validate(
				{
					rules : {
						hovaten : {
							required : true,
