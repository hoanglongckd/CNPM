<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
	    ...
	    <script src="<%=request.getContextPath()%>/public/datetimepicker/js/daterangepicker.js"></script>
	    ...
	    <script src="<%=request.getContextPath()%>/public/bower_components/datatables/media/js/jquery.dataTables.min.js"></script>
